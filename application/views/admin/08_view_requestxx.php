            ...
            <table class="table">
              ...
              <tbody>
               ...
               <tr>
                  ...
                  <td></td>
                  <td>
						<a href="<?= site_url('welcome/button_approve');?>/<?= $key->id_trx; ?>" class="btn btn-success">Approve</a>
						<a href="<?= site_url('welcome/button_deny_request');?>/<?= $key->id_trx; ?>" class="btn btn-danger">Deny</a>
                  </td>
                </tr> 
                <?php } ?>
              </tbody>
